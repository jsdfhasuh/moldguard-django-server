...
MOLDGUARD_WEBHOOK_PROBE_URL = os.getenv("MOLDGUARD_WEBHOOK_PROBE_URL", "").strip()
MOLDGUARD_WEBHOOK_PROBE_TIMEOUT = env_positive_int("MOLDGUARD_WEBHOOK_PROBE_TIMEOUT", 10)
MOLDGUARD_WEBHOOK_PROBE_TTL_SECONDS = env_positive_int("MOLDGUARD_WEBHOOK_PROBE_TTL_SECONDS", 600)
